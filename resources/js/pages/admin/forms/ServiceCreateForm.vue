                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-600 text-sm
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div
                            class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed
                                   border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition"
